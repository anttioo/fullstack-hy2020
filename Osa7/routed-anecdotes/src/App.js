    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                <div>
                    content
                    <input name='content' { ...withoutReset(content) }/>
                </div>
                <div>
                    author
                    <input name='author' { ...withoutReset(author) }/>
                </div>
                <div>
                    url for more info
                    <input name='info' { ...withoutReset(info) }/>
                </div>
...
const AnecdoteViewer = ({content, author, info, votes}) => {
    return <div>
